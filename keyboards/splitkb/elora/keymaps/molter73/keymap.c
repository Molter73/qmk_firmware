 ...
 */
    [_MEDIA] = LAYOUT_myr(
      ...
      _______, KC_PSCR, LGUI(KC_PSCR), _______, _______, _______,          _______, _______,          _______, KC_1   , KC_2   , KC_3   , _______, _______,
      _______, KC_MPRV, KC_MNXT      , _______, _______, KC_MPLY, _______, _______, _______, _______, _______, KC_0   , KC_DOT , _______, _______, _______,
